// const github_api="https://www.linkedin.com/in/mrjha/";
// const user=fetch(github_api);    //returns the promise
// console.log(user);
// //promise:-- {<pending>}
// //when async operation is done then in that case promise_state is fulfilled

// user.then(function(data){
//     console.log("Promise is fulfilled");
// })

//as soon as the data is there in user(promise) object then call function will be executed
